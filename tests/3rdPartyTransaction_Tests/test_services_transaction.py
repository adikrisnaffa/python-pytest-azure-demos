...
def test_title_assertion(setup):
    ...
    #==================================================================================================================================================================
    # SCENARIO / TESTCASE 2 : MEMBUKA DROPDOWN TRANSACTION
    #==================================================================================================================================================================
@pytest.mark.transactionmenu
def test_open_background_log_dropdown(self, setup):
    # Membuka dropdown Transaction
    transaction_dropdown = setup.find_element(By.CSS_SELECTOR, "a[data-bs-target='#nav-menu-transaction']")
    transaction_dropdown.click()
    time.sleep(1) 

    # Verifikasi bahwa dropdown telah terbuka
    transaction_menu = setup.find_element(By.ID, "nav-menu-transaction")
    assert transaction_menu.is_displayed(), "Dropdown Transaction tidak terbuka"

@pytest.mark.transactionmenu
def test_transaction_menu_items(setup):
    # Membuka dropdown Transaction
    transaction_dropdown = setup.find_element(By.CSS_SELECTOR, "a[data-bs-target='#nav-menu-transaction']")
    transaction_dropdown.click()
    time.sleep(1) 

    # Mengumpulkan daftar item menu Transaction yang diharapkan
    expected_menu_items = [
        "BAST",
        "Invoice",
        "Payment Approval",
    ...
    actual_menu_items = setup.find_elements(By.XPATH, "//ul[@id='nav-menu-transaction']//span")
    ...
    #==================================================================================================================================================================
    # SCENARIO / TESTCASE 3 : MEMBUKA SEMUA LIST DROPDOWN DARI TRANSACTION MENU
    #==================================================================================================================================================================
@pytest.mark.transactionmenu
def test_open_and_verify_transaction_pages(setup):
# Daftar nama menu Transaction
    ...
    # Daftar nama Title 3rd Party Transaction
    title_names = [
        "iVendor - BAST",
        "iVendor - Invoice",
        "iVendor - Payment Approval",
        "iVendor - Tracking"
    ]
    ...
    # Melakukan iterasi pada setiap menu Transaction
    for menu_item in transaction_menu_items:
